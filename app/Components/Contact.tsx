...
const Contact = () => {
  ...
  const handleMessageChange = (
    ...
    setMessage(event.target.value); // Update the state as user types
  };
  return (
      ...
      <div className="contact-grid md:grid-cols-2 ">
        <div className="contact-space">
          ...
          <p className="contact-text">
            Drop me a line, give me a call , or send me a message by a
            submitting the form.
          </p>
          ...
          <div className="contact-flex" data-aos="fade-down">
            ...
            <a href="https://wa.me/+923173894947/">(+92-3173894947)</a>
          </div>
          <div className="contact-flex" data-aos="fade-down">
            <FaLinkedin size={30} />{" "}
            <a href="https://www.linkedin.com/in/saim-shaikh-a7459a290/">
              Linkedin.com/in/saim-shaikh
            </a>
          </div>

          <div className="contact-flex" data-aos="fade-down">
            <FaSquareXTwitter size={30} />{" "}
            <a href="https://x.com/Saimshaikh111">X.com/Saim-shaikh111</a>
          </div>
        </div>
        <div className="contact-space">
